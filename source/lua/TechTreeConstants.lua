...
kTechId = createTechIdEnum({
    ...
    'DropJetpack', 'DropExosuit', 'DropDualRailgunExosuit',
    ...
    // Armor
    'Jetpack', 'JetpackFuelTech', 'JetpackArmorTech', 'Exosuit', 'DualRailgunExosuit', 'ExosuitLockdownTech', 'ExosuitUpgradeTech',
